...
{
    public partial class SpecAngleForm : Form
    {
        ...
        private void match()
        {
            ...
            md.MatchAnswer(ukProfileList, ProfileList, 0, level);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            OutputData.ExportExcel("光谱角匹配", Parameter.BriefInformation("光谱角匹配"), MatchDis.HMatrix, MatchDis.HProfile, SheetName);
        }
